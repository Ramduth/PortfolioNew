...
function Hero() {
  return (
    <div
      className="min-h-screen w-full flex items-center py-20 px-4 md:px-16 max-w-screen-2xl mx-auto"
    >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-12 items-center">
          <div className="order-2 lg:order-1 animate-on-scroll fade-in-left">
            <div className="mb-6">
              ...
              <p className="text-base md:text-xl  text-muted-foreground font-Roboto mb-6 w-full md:max-w-xl text-gray-400">
                Hardworking MERN Stack Developer, self-learner, and passionate
                about exploring new technologies. Skilled in building scalable
                web apps, RESTful APIs, and user-centric solutions with React,
